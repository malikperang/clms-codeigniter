...
<?php 
  ...
  if($result):?>
  <div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button><?php echo $result;?></div>
  <?php endif;?>
	<table class="table table-bordered table-hover table-custom widget-margin ">
	<tr>
	...
	{?>
		<h1><?php echo "Tiada data lagi!";?></h1>
	<?php }
?>
</table>
<?php echo form_close();?>
