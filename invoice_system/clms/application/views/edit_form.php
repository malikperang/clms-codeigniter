...
<?php if(isset($update_error)):
      echo '<div class="alert alert-error"><h4>Amaran!</h4><button type="button" class="close" data-dismiss="alert">&times;</button>' . $update_error .'</div>';
      endif ?> 
<?php if(isset($update_success)):
      echo '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button>' . $update_success .'</div>';
      endif ?> 
<table>
...
<div class="span6 widget">
  <div class="span12 image-widget">
    <img class="profile-image" src="<?php echo base_url();?>/images/gallery/<?php echo $row->image_name;?>">
    <br />
