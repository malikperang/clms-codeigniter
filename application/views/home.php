...
<div class="input-prepend">
 ...
 <input class="span3" id="prependedInput" size="150" type="text" name="name" >
</div>
<span class="help-block"><i>*e.g:Abu bin Ali</i></span>
  ...
  <tr>
    ...
    <div class="input-prepend">
    <span class="add-on"><i class="icon-user"></i></span>
    <input class="span3" id="prependedInput" size="150" type="text" name="ic_num">
 </div>
  ...
  <td>
    ...
    <input class="span3" id="prependedInput" size="150" type="text" name="address">
    </div>
    <div class="input-prepend">
    <span class="add-on"><i class="icon-road"></i></span>
    <input class="span3" id="prependedInput" size="150" type="text" name="second_address">
    </div>
  ...
  <td>
    ...
    <input class="span3" id="prependedInput" size="150" type="text" name="phone_num">
    </div>
  ...
  <td>
    <div class="input-prepend">
    <span class="add-on"><i class="icon-envelope"></i></span>
     <input class="span3" id="prependedInput" size="150" type="text" name="email">
    </div>
